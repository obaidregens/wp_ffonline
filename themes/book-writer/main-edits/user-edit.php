...
<?php if (current_user_can('author') == false) { ?>
...
<tr class="user-nickname-wrap">
	<th><label for="nickname"><?php _e( 'Pen Name' ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
...
<th><label for="<?php echo $name; ?>">
	...
	<h2><?php IS_PROFILE_PAGE ? _e( 'About' ) : _e( 'About the user' ); ?></h2>

<table class="form-table" role="presentation">
<tr class="user-description-wrap">
	<th><label for="description"><?php _e( 'Describe Yourself' ); ?></label></th>
