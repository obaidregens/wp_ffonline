...
if (! is_edit_valid($_POST['chapter_id'],'chapter',$_POST['book_id']) ){
    exit();
}
...
$chapter_id = $_POST['chapter_id'] === 'new' ? 0 : $_POST['chapter_id'];
$autosaves = get_autosaves($_POST['book_id'],$chapter_id);
krsort($autosaves);
