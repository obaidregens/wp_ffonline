...
foreach($bookmarks as $bookmark){
    ...
    ?>
    <li onclick="window.location = '<?php echo get_permalink($chapter->ID) . '#p-' . $bookmark[1]; ?>'" id="<?php echo 'li-' . $bookmark[0] . '_' . $bookmark[1]; ?>" style="color:black !important;padding-left:20px;border-radius:0%;" class="btn-hover collection-item avatar">
