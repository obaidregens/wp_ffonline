<?php
/**
 * The template part for displaying a message that chapters cannot be found
 *
 * @package WordPress
...
<section class="no-results not-found">
	...
	<div class="page-content">
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			<p><?php printf( __( 'Ready to add the first chapter?  <a href="%1$s">Write here</a>.', 'twentysixteen' ), esc_url( admin_url( 'post-new.php?post_type=chapter' ) ) ); ?></p>
