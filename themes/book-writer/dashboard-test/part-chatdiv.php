...
?>
<div id="user_info" value="<?php echo $user->ID; ?>" style="padding:20px;" class="row"><?php echo $user->display_name; logged_in_status($user,true); ?></i></div>
...
<div class="row">
    <?php
    if(get_user_meta($user->ID,'allow_messaging',true) == 'disable' && $user->ID != get_current_user_id()){
        ?>
        ...
        <div class="input-field col m11 s10">
            <input placeholder="Type a message..." id="message" type="text">
        </div>
