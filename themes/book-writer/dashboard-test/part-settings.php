<main class="mobile-margin">
    ...
    <div class="row">
    	...
    	<div class="input-field col s12">
    		<div class="switch center-block" style="padding-left:10px;">
    			<label>
    				<input id="emails_notifications" type='checkbox' value='notify' <?php if(get_user_meta(get_current_user_id(),'fav_notify',true) == 'notify' || get_user_meta(get_current_user_id(),'fav_notify',true) === ''){echo 'checked';}?>>
    				<span class='lever'></span>
...
function save_settings(){
	...
	if (document.querySelector("#emails_notifications").checked == true){
		var emails_notifications = 'notify';
	}
	else{
		var emails_notifications = 'disable';
	}
