...
<?php $books = get_pages(array(
    ...
    <ul id="dashboard-sidenav" class="sidenav sidenav-fixed">
        ...
        <li class="dashboard_li btn-hover active"><a onclick="load_page('dashboard')"><i style="margin:0;" class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        <li class="edit-book_li edit-chapter_li btn-hover write_li"><a onclick="load_page('write')"><i style="margin:0;" class="fas fa-pencil-alt"></i>Write</a></li>
        <li class="profile_li btn-hover"><a onclick="load_page('profile')"><i style="margin:0;" class="fas fa-user"></i>Profile</a></li>
        <?php if (!empty($books)){
