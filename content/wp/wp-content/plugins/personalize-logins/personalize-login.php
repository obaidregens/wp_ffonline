<?php
/**
 * Plugin Name:       2-Personalize Login
...
class Personalize_Login_Plugin {
	...
	public function redirect_to_custom_register() {
		if ( 'GET' == $_SERVER['REQUEST_METHOD'] ) {
			if ( is_user_logged_in() ) {
				...
				wp_redirect( home_url( 'login/#signup_tab' ) );
			}
			exit;
		}
	}
	...
	public function redirect_to_custom_lostpassword() {
		if ( 'GET' == $_SERVER['REQUEST_METHOD'] ) {
			...
			wp_redirect( home_url( 'login#forgot_pass_tab' ) );
			exit;
		}
	}
	...
	public function do_register_user() {
		if ( 'POST' == $_SERVER['REQUEST_METHOD'] ) {
			$redirect_url = home_url( 'login/#signup_tab' );
	...
	public function do_password_lost() {
		if ( 'POST' == $_SERVER['REQUEST_METHOD'] ) {
			...
			if ( is_wp_error( $errors ) ) {
				// Errors found
				$redirect_url = home_url( 'login#forgot_pass_tab' );
